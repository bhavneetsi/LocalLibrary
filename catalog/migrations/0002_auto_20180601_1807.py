# Generated by Django 2.0.5 on 2018-06-01 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='Enter Author Name', max_length=200)),
                ('last_name', models.CharField(help_text='Enter Author Name', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Enter Author Name', max_length=200)),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Uniqueid for the book instance', primary_key=True, serialize=False)),
